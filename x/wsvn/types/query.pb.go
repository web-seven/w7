...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4217690f961d0e4a, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4217690f961d0e4a, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "wsvn.wsvn.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "wsvn.wsvn.QueryParamsResponse")
}

func init() { proto.RegisterFile("wsvn/wsvn/query.proto", fileDescriptor_4217690f961d0e4a) }

var fileDescriptor_4217690f961d0e4a = []byte{
	// 289 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2d, 0x2f, 0x2e, 0xcb,
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x0a, 0x4d, 0xc3, 0xcc, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/wsvn.wsvn.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wsvn.wsvn.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "wsvn/wsvn/query.proto",
}
